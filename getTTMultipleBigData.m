function [IniY gt vdistM nTest] = getTTMultipleBigData(mDist,mPara,mTrainTestSplitBig)
...
%     gt(nTrain+nPosTest+1:nAll, 1) = 0;
    ...
    vdistM = cell(4,1);
    mExpFea = mPara.mExpFea{mPara.iExp};
    
    nExpFea = size(mExpFea,1);
    for iFeature =1:nExpFea
        tmpDistM = mDist{iFeature,mPara.iFea};% the feature matrix for all samples in the dataset
